...
SECRET_KEY = 'django-insecure-ntcc^zsetz6&*(6qr5jydk$7^6=wzmrqe$w2e(qe@ffp5xudv='
...
ROOT_URLCONF = 'statuskeeper.urls'
...
WSGI_APPLICATION = 'statuskeeper.wsgi.application'
